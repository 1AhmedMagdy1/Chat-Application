    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(spChat, javax.swing.GroupLayout.DEFAULT_SIZE, 687, Short.MAX_VALUE)
                .addGap(16, 16, 16))
...
popUp.setVisible(false);
 ...
 start();
    ...
    private void getMessage( String ms) {
        if (!txt.getText().equals("")) {                 
     q.insert_txt(ms,username);/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void recievetxt(String msg,boolean indb){
        System.out.println(indb);
        if(indb){
            String []mssages=q.historyotxt(username,"msg" );
            int length=mssages.length;
            for (int i = 0; i < length; i++) {
                 Send_Box_New box = new Send_Box_New();
                box.setMessage(msg,username);
                panelChat.add(box);
                txt.setText("");
                txt.grabFocus();
                refresh(panelChat);
  ...
  private void setImage() {
        ...
        if (c == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                fin.read(content);
                q.insert_img(imageNmame,content,username);///////////////////////////////////////////////////////////////////////////////
                dout.writeInt(size);
        ...
        if (c == JFileChooser.APPROVE_OPTION){
           // Method.sendFile(ch.getSelectedFile());
            ...
            try {
               ...
               q.insert_file(filename, content,username);////////////////////////////////////////////////////////////////////////////////
                dout.writeInt(size);
...
while(true){
          synchronized(din){
              try {
                ...
                msg=din.readUTF();
                q.insert_txt(msg,username);/////////////////////////////////////////////////////////////////////
             
                recievetxt(msg,q.signedup(username));
                  }
               ...
               din.readFully(content, 0, size);
                String imagename=din.readUTF();
                   //////////
               q.insert_img(imagename, content,username);//////////////////////////////////////////////////////////////////
